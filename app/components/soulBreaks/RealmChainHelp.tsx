      ...
      <CollapsibleLink id="realm-chain-help" title="A note on terminology">
        <ul>
          ...
          <li>
            ...
            instant cast and provide party-wide buffs of +30 ATK/DEF/MAG/RES and instacast 1. They
            were intended to counter the Full Break effects that higher-end Cardia bosses use, but
            they're of limited use for that; restarting a chain can hurt your damage almost as much
            as a Dreambreaker Full Break. They remain useful as general party buffs.
          </li>
          <li>
            A <strong>RW</strong> (Roaming Warrior) chain, Bonds of Historia, is available in Cardia
            battles. It boosts damage of the corresponding realm by <strong>30%</strong> and offer a
            chain bonus up to <strong>150 hits</strong> but has no other effects.
          </li>
        </ul>
      </CollapsibleLink>
    );
