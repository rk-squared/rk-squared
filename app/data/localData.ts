...
export const labyrinthIcons: { [id in DisplayPaintingId]: string | undefined } = {
  ...
  [DisplayPaintingId.Treasure1]: require('../images/game-icons/open-treasure-chest-gold.svg'),
  [DisplayPaintingId.Treasure2]: require('../images/game-icons/open-treasure-chest-gold.svg'),
  [DisplayPaintingId.Treasure3]: require('../images/game-icons/open-treasure-chest-gold.svg'),
